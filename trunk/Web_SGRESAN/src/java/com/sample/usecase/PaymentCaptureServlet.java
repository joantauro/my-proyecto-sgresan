...
public class PaymentCaptureServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		}else if(request.getRequestURI().contains("Prueba")){
			getServletConfig().getServletContext()
			.getRequestDispatcher("/usecase_jsp/Prueba.jsp")
			.forward(request, response);
	...
	protected void doPost(HttpServletRequest request,
		...
		response.setContentType("text/html");
		          System.out.println("Se ejecuta el doPost de PaymentCaptureServlet");
		...
		if(request.getRequestURI().contains("SetExpressCheckoutPaymentAuthorization") || request.getRequestURI().contains("Prueba")){
			...
			if (resp != null) {
				...
				if (resp.getAck().toString().equalsIgnoreCase("SUCCESS")) {
                                    System.out.println("ACK" + resp.getAck().toString());
			...
			if (doCheckoutPaymentResponseType != null) {
				...
				if (doCheckoutPaymentResponseType.getAck().toString()
						.equalsIgnoreCase("SUCCESS")) {
                                    System.out.println("ACK "+doCheckoutPaymentResponseType.getAck().toString());
					Map<Object, Object> map = new LinkedHashMap<Object, Object>();
					...
					while (iterator.hasNext()) {
						...
						map.put("Transaction ID" + index,
								result.getTransactionID());
                                                System.out.println(doCheckoutPaymentResponseType.getAck()+"_"+result.getTransactionID());
						index++;
					}
